...
Octarine is under active development. The cache currently rebuilds at launch, watcher reconfiguration and filesystem-root enforcement are incomplete, and IPC contracts are still maintained manually. See `docs/architecture.md` and `docs/roadmap.md` for the honest implementation boundary.
