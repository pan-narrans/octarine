...
Octarine is under active development. Watcher reconfiguration and filesystem-root enforcement are incomplete, and IPC contracts are still maintained manually. See `docs/architecture.md` and `docs/roadmap.md` for the honest implementation boundary.
